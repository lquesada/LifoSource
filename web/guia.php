...
function iweb() {
  ...
  gshow('prohibido','¿Qué está prohibido?',"Los ataques al servidor, el robo de cuentas, los insultos y palabras malsonantes, comentarios racistas, sexistas, y demás, parafernalia política o militar, provocaciones, abuso de multicuentas, envío masivo de mensajes al foro o a otros jugadores, la publicidad, provocaciones a otros jugadores, amenazas, y aprovechamiento de fallos del juego. Todas estas actividades podrán ser sancionadas con ban (prohibición de entrada al juego) o reducciones de experiencia, eliminación de objetos, y demás medidas, según la gravedad de la actividad.");
