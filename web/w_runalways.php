...
db_unlock();
$contador2 = mysql_fetch_row($retvalcon2);
mysql_free_result($retvalcon2);
if ($contador2[0]<$time) {
...
db_unlock();
$contador = mysql_fetch_row($retvalcon);
mysql_free_result($retvalcon);
$hacer = 0;
if ($contador[0]<$time) {
